                            ...
                            {images.map((image) => {
                                return (
                                    <div className="flex flex-col "   >
                                        <motion.div className=' rounded-sm p-8 w-80 h-64 ' key={image.key} onClick={() => handleClick(image)}    >
                                            <Image src={image.image} alt="" width={1080} height={700} className='w-full h-full rounded-md hover:cursor-pointer active:pointer-events-none' />
                                        </motion.div>
